...
- **AI Agent (LangChain)**: Use LangChain tools in the Node.js backend. LLM is powered by Groq API (`https://api.groq.com/openai/v1`) using `openai/gpt-oss-120b` (vision via `qwen/qwen3.6-27b`) with `GROQ_API_KEY`.
